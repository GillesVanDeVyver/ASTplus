...
import dataloader
from Anomaly_soud_event_detection.src import models
import numpy as np
...
parser.add_argument("--model", type=str, default='ast_model', help="the model used")
...
os.makedirs("%s/ast_model" % args.exp_dir)
...
if args.dataset == 'speechcommands':
    ...
    sd = torch.load(args.exp_dir + '/ast_model/best_audio_model.pth', map_location=device)
