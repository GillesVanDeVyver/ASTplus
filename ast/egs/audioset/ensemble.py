...
def get_ensemble_res(mdl_list, base_path):
    # the 0-len(mdl_list) rows record the results of single ast_model, the last row record the result of the ensemble model.
    ...
    for model_idx, mdl in enumerate(mdl_list):
        ...
        # sd = torch.load('/Users/yuan/Documents/ast_model/pretrained_models/audio_model_wa.pth', map_location=device)
...
args.label_csv='/data/sls/scratch/yuangong/ast_model/egs/audioset/class_labels_indices.csv'
...
mdl_list_s = ['/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4495.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4483.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4475.pth']

# formal full ensemble, ensemble-M
mdl_list_m = ['/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4495.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4483.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_10_10_0.4475.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_12_12_0.4467.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_14_14_0.4431.pth',
'/data/sls/scratch/yuangong/ast_model/pretrained_models/ensemble/audioset_16_16_0.4422.pth']

# ensemble 3 ast_model that is trained with same setting, but different random seeds
get_ensemble_res(mdl_list_s, './exp/ensemble_s')
# ensemble 6 ast_model that is trained with different settings (3 with stride of 10, others are with stride of 12, 14, and 16)
